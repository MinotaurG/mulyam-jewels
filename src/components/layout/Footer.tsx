 ...
 * - Contact info
 * 
 * Uniqlo-style: Clean, organized, lots of whitespace.
 */
...
const footerLinks = {
  shop: {
    title: 'Shop',
    links: [
      { label: 'Pet Jewelry', href: '/collections/pets' },
        ...
        */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <Link 
              href="/" 
              className="text-xl font-light tracking-[0.3em] text-neutral-800"
            >
              MULYAM
            </Link>
            ...
            <p className="mt-4 text-sm text-neutral-600 leading-relaxed">
              India's first fashion jewelry brand for pets. 
              Elegant pieces for women, kids, and your furry friends.
            </p>
